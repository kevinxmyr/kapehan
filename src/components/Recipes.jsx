...
export default function Recipes() {
  return (
    <div
      ...
      {/* FIRST ITEM */}
      <div
        className='bg-slate- col-start-3 row-start-2 w-[20rem] mb-[2rem]
        justify-center 
        max-w-[391px]
        iPad:col-start-3
        lt:col-start-1
        ...
        <p className='font-rufina leading-8'>
          ...
          to be. Every month, we combine some of our favorite sourdough recipes
          together.
        </p>
      </Fade>
      </div>
      ...
      <div
        className='bg-slate- col-start-3 row-start-4 w-[20rem] mb-[2rem]
          iPad:col-start-3
          lt:col-start-1'>
            <Fade cascade>
      ...
      <div
        className='bg-slate- col-start-3 row-start-6 pb-[3rem] w-[20rem]
          iPad:col-start-3
          lt:col-start-1'>
            <Fade cascade>
      ...
      {/* ITEM 4 PICTURE */}
      <div
        className='row-start-7 row-end-[8] col-start-3 col-span-3
        iPad:col-start-3
        lt:col-start-3
        lt:row-start-1
        '>
